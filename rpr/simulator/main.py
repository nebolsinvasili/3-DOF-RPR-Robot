...
from .logics.logging import log, write
from .logics.target import points
...
xyz = [
    (coord, angle) for coord, angle in points(radius=radius, limit=limit, R=R, r=r, n=n)
]
